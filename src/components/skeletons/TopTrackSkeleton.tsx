...
const TopTrackSkeleton: React.FC = () => {
  return (
    <div className="song-container flex p-4 my-4 md:my-8 rounded-md items-center bg-gray-600/[.5] animate-pulse">
...
export default TopTrackSkeleton;
